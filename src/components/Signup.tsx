        ...
        <div className="flex justify-around items-center mt-8">
            <form className="flex flex-col justify-center items-center min-w-max max-w-lg">
                ...
                <label htmlFor="email" className="block flex-1">
                    ...
                    <input id="email" type="text" className="block m-2 mb-4 rounded-md p-2 w-full border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="Username: "></input>
                </label>
